...
const emailAddress = "taghzoutimane@gmail.com";
const emailSubject = "Applied AI portfolio conversation";
const emailBody = "Hello Imane,\n\nI would like to discuss an applied AI opportunity.";
  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section id="contact" data-chapter="07 / CONTACT" className="contact-section page-section"><div className="section-transition"><span>06 → 07</span><strong>From capability to conversation.</strong></div><div className="contact-inner"><p className="eyebrow">Have a good problem?</p><h2>Let&apos;s make the<br /><em>signal clearer.</em></h2><a className="button button-light" href={emailUrl} target="_blank" rel="noreferrer" aria-label={`Email Imane at ${emailAddress}`}>Email Imane <Mail size={17} /></a><p className="contact-note">Open to Data Scientist, Data Analyst, and ML Engineer opportunities in applied AI, consulting, financial services, and LLM powered products.</p></div><div className="contact-index">07<br /><span>CONTACT</span></div></section>
      </main>

      <footer className="site-footer"><div><img src={monogram} alt="" className="footer-mark" /><span>IMANE TAGHZOUT<br /><small>Data Scientist · AI Engineer</small></span></div><div className="footer-links"><a href="https://github.com/imane-tag" target="_blank" rel="noreferrer"><Github size={16} /> GitHub</a><a href="https://linkedin.com/in/imane-taghzout" target="_blank" rel="noreferrer"><Linkedin size={16} /> LinkedIn</a><a href={emailUrl} target="_blank" rel="noreferrer" aria-label={`Email Imane at ${emailAddress}`}><Mail size={16} /> Email</a></div><p>© 2026 Imane Taghzout. Built with intent.</p></footer>
